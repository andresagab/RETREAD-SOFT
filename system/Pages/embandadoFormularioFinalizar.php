...
if (isset($_GET['id'])) {
    ...
    $inspeccionInicial=$objeto->getCorteBanda()->getRelleno()->getCementado()->getReparacion()->getPreparacion()->getRaspado()->getInspeccion();
...
<div class="col-md-12" ng-controller="rechazoLlanta">
    ...
    <div class="row col-md-12 text-capitalize" id="paddinTop20">
        ...
        <div class="col-md-10">
            <form class="form-horizontal" name="formulario" method="POST" action="principal.php?CON=system/Pages/embandadoActualizar.php">
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group center-block" id="divBtnSeleccionarRechazos" ng-show="!html.estado">
                        <button class="btn btn-success" id="btnSeleccionarRechazos" type="button" href="/#seleccionarRechazos" data-toggle="modal" ng-click="loadRechazosOfProceso(<?=$llanta->getId()?>, 7)">Seleccionar rechazos</button>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                ...
                <div class='modal-footer'>
                    ...
                    <a href="/#solicitudEnviada" data-toggle="modal">
                        <button ng-hide="!chequeados" type='button' class='btn btn-success {{ objeto.btnAprobar }}' id="btnAprobar" data-dismiss="modal"
                                ng-click="registrarRechazos(<?= $objeto->getId() ?>, observaciones, 7, <?=$llanta->getId()?>)"
                                >Registrar</button>
                    </a>
                </div>
            </div>
