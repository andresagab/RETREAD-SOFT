...
if (isset($_GET['id'])) {
    $objeto=new Revision_Tecnomecanica('id', $_GET['id'], null, null);
...
<div class="col-md-12">
    ...
    <div class="col-md-8 col-sm-12" >
        <strong class="text text-success control-label"><h2><?=$accion?> revision tecnomecanica del vehiculo <?= rtrim($vehiculo->getPlaca())?></h2></strong>
    </div>
    <div class="col-md-2 col-sm-12"></div>
    <div class="row col-md-12 text-capitalize" id="paddinTop20">
        <div class="col-md-1"></div>
        <div class="col-md-10">
            <form class="form-horizontal" name="formulario" method="POST" action="principal.php?CON=system/Pages/tecnomecanicasvehiculoActualizar.php">
                <div class="col-md-3"></div>
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon">Fecha Expedicion:</span>
                            <input type="date" class="form-control has-primary input-sm" name="fechaExpedicion" value="<?= $objeto->getFechaExpedicion()?>" required="" data-toggle="tooltip" title="Este campo es obligatorio"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                    ...
                    <div class="form-group" id="paddinTop30">
                         ...
                         <div class="col-md-2"><a href="principal.php?CON=system/Pages/tecnomecanicasVehiculo.php&id=<?=$vehiculo->getId()?>&idCliente=<?=$_GET['idCliente']?>"><input class="btn btn-danger" type="button" name="Cancelar" value="Cancelar"></a></div>
                         <div class="col-md-2"></div>
