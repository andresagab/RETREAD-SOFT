...
if (isset($_GET['idCorteBanda'])) header ("Location: principal.php?CON=system/Pages/embandadoActualizar.php&idCorteBanda={$_GET['idCorteBanda']}&accion=preRegistro");
else {
    if (isset($_GET['id'])) {
        $objeto=new Embandado('id', $_GET['id'], null, null);
        $corteBanda=$objeto->getCorteBanda();
        ...
        $objeto->setIdCorteBanda($_GET['idCorteBanda']);
        $corteBanda=$objeto->getCorteBanda();
        $relleno=$corteBanda->getRelleno();
        $cementado=$relleno->getCementado();
        $reparacion=$cementado->getReparacion();
...
<div class="col-md-12" ng-controller="usosInsumosPuestoTrabajo">
    <div class="hide" id="cargarDatos" ng-click="cargarProceso(<?= $objeto->getId() ?>, 'getEmbandadoJSON');cargarEmpleado(<?= $USUARIO->getIdEmpleadoUsuario() ?>);setNumeroProceso(7)"></div>
    <div class="col-md-4" ></div>
    <div class="col-md-4" >
        <strong class="text text-uppercase mdl-color-text--blue control-label"><h2><?=$accion?> embandado</h2></strong>
    </div>
    <div class="col-md-4" >
    ...
    <div class="row col-md-12" id="paddinTop20">
        ...
        <div class="col-md-10" >
            <form class="form-horizontal" name="formulario" method="POST" action="principal.php?CON=system/Pages/embandadoActualizar.php" enctype="multipart/form-data">
                <div class="col-md-2"></div>
                <div class="col-md-8">
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon">* Puesto de trabajo:</span>
                                <select ng-disabled="html.spnListaPuestosTrabajo" class="form-control has-primary input-group-sm" name="idPuestoTrabajo" id="puestoTrabajo" ng-model="html.idPuestoTrabajo" ng-change="cargarPuestoTrabajo(html.idPuestoTrabajo)"><?= Puesto_Trabajo::getDatosEnOptions("proceso=7", null, null)?></select>
                    ...
                    <div class="form-group hide">
                        <div class="input-group">
                            ...
                            <select class="form-control has-primary input-group-sm" name="idGravado" id="spnGevados" ><?= Gravado_Llanta::getDatosEnOptions(null, null, $objeto->getIdGravado())?></select>
                        </div>
                    </div>
                    <div class="form-group hide">
                        <div class="input-group">
                            <span class="input-group-addon">Ancho banda:</span>
                            <input class="form-control" id="txtAnchoBanda" type="text" name="anchoBanda" placeholder="Ejm: 190 mm" min="0">
                        </div>
                    </div>
                    <div class="form-group hide">
                        <div class="input-group">
                            <span class="input-group-addon">Largo banda:</span>
                            <input class="form-control" id="txtLargoBanda" type="text" name="largoBanda" placeholder="Ejm: -11.03 mts" min="0">
                        </div>
                    </div>
                    <div class="form-group hide">
                        <div class="input-group">
                            <span class="input-group-addon">Empates:</span>
                            <input class="form-control has-primary" type="number" name="empates" placeholder="Ejm: 1" min="0">
                        </div>
                    </div>
                    ...
                    <div class="hidden">
                        ...
                        <div class="col-md-12"><input type="hidden" name="idCorteBanda" value="<?=$objeto->getIdCorteBanda()?>"></div>
