...
if (isset($_GET['idRaspado'])) header ("Location: principal.php?CON=system/Pages/preparacionActualizar.php&idRaspado={$_GET['idRaspado']}&accion=preRegistro");
else {
    if (isset($_GET['id'])) {
        ...
        $objeto->setIdRaspado($_GET['idRaspado']);
        $raspado=$objeto->getRaspado();
        $inspeccionInicial=$raspado->getInspeccion();
        $servicio=$inspeccionInicial->getLlanta()->getServicio();
        $accion="Registrar";
...
<div class="col-md-12" ng-controller="usosInsumosPuestoTrabajo">
    <div class="hide" id="cargarDatos" ng-click="cargarProceso(<?= $objeto->getId() ?>, 'getPreparacionJSON');cargarEmpleado(<?= $USUARIO->getIdEmpleadoUsuario() ?>);setNumeroProceso(2)"></div>
            ...
            <form class="form-horizontal" name="formulario" method="POST" action="principal.php?CON=system/Pages/preparacionActualizar.php" enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon">* Puesto de trabajo:</span>
                                <select ng-disabled="html.spnListaPuestosTrabajo" class="form-control has-primary input-group-sm" name="idPuestoTrabajo" id="puestoTrabajo" ng-model="html.idPuestoTrabajo" ng-change="cargarPuestoTrabajo(html.idPuestoTrabajo)"><?= Puesto_Trabajo::getDatosEnOptions("proceso=2", null, null)?></select>
                    ...
                    <div class="hidden">
                        ...
                        <div class="col-md-12"><input type="hidden" name="idRaspado" value="<?=$objeto->getIdRaspado()?>"></div>
                    ...
                    <div class="form-group" id="paddinTop30">
                        <a href="principal.php?CON=system/Pages/procesoServicio.php&id=<?=$objeto->getRaspado()->getInspeccion()->getIdLlanta()?>"><input class="btn btn-danger" type="button" name="Cancelar" value="Cancelar"></a>
                        ...
                        <div role="tabpanel">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="lista">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <div class="col-sm-12 col-lg-10">
                                            <strong class="text text-success control-label"><h2>Herramientas</h2></strong>
                                        </div>
                                        <div class="col-sm-12 col-lg-1" id="paddinTop20">
                                    ...
                                    <div class="col-lg-12" ng-show="html.noInsumo" id="paddinTop20">
                                        <div class="alert alert-danger">No hay herramientas disponibles</div>
                                    </div>
                                                ...
                                                <table class="mdl-data-table mdl-js-data-table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="mdl-data-table__cell--non-numeric" ng-click="orden='cantidad'">Cantidad</th>
                                ...
                                <div ng-repeat="dato in insumos" role="tabpanel" class="tab-pane" id="usarInsumo_{{ dato.id }}">
                                    <div class="col-sm-12 col-lg-12" id="paddinTop10">
                                        <div class="col-md-12 col-sm-12 table-responsive" >
                                            <strong class="text text-success control-label"><h2>Usar herramienta</h2></strong>
                                        </div>
                                        <div class="row col-md-12">
                                            <div class="col-md-12 page-header" id="paddinTop-20">
                                                ...
                                                <div class="col-sm-12 col-lg-6 text-justify">
                                                    <label class="text-nowrap text-uppercase">Herramienta: </label><span class="text text-muted"> {{ dato.insumo[0].nombrePuc }}</span>
                                                </div>
                                                <div class="col-sm-12 col-lg-6 text-justify">
                                            ...
                                            <div class="col-sm-12 col-lg-12 text-center" id="paddinTop10">
                                                <label class="text text-nowrap text-uppercase">Esta seguro de usar esta herramienta?</label>
                                            </div>
                                ...
                                <div role="tabpanel" class="tab-pane" id="UsarYTerminarInsumo">
                                    <div class="col-sm-12 col-lg-12" id="paddinTop10">
                                        <div class="col-md-12 col-sm-12 table-responsive" >
                                            <strong class="text text-success control-label"><h2>Usar y terminar herramienta</h2></strong>
                                        </div>
                                        <form name="frmUsarYTerminar" id="frmUsarYTerminar" ng-submit="UsarYTerminarInsumo(insumoUsarYTerminar.id, true)">
                                            <div class="row col-md-12">
                                                <div class="col-sm-12 col-lg-12 page-header" id="paddinTop-20">
                                                    ...
                                                    <div class="col-sm-12 col-lg-6 text-justify">
                                                        <label class="text-nowrap text-uppercase">Herramienta: </label><span class="text text-muted"> {{ insumoUsarYTerminar.insumo[0].nombrePuc }}</span>
                                                    </div>
                                                    <div class="col-sm-12 col-lg-6 text-justify">
                                                ...
                                                <div class="col-sm-12 col-lg-12 text-center" id="paddinTop10">
                                                    <label class="text text-nowrap text-uppercase">Esta seguro de usar y terminar esta herramienta?</label>
                                                </div>
                                                <div class="col-sm-12 col-lg-12" id="paddinTop20">
                                                    <div class="col-md-12">
                                ...
                                <div role="tabpanel" class="tab-pane" id="_TerminarInsumo">
                                    <div class="col-sm-12 col-lg-12" id="paddinTop10">
                                        <div class="col-md-12 col-sm-12 table-responsive" >
                                            <strong class="text text-success control-label"><h2>Terminar herramienta</h2></strong>
                                        </div>
                                        <form name="frmTerminar" id="frmTerminar" ng-submit="UsarYTerminarInsumo(insumoUsarYTerminar.id, false)">
                                            <div class="row col-md-12">
                                                ...
                                                <div class="col-sm-12 col-lg-12 text-center" id="paddinTop10">
                                                    <label class="text text-nowrap text-uppercase">Esta seguro terminar esta herramienta?</label>
                                                </div>
                                                <div class="col-sm-12 col-lg-12" id="paddinTop20">
                                                    <div class="col-md-12">
                                                        <button id="btnRegresarLista_2" class="btn btn-default" type="button" href="/#lista" aria-control="" data-toggle="tab" role="tab" ng-click="limpiarUsarYTerminarInsumo()">Regresar</button>
                                ...
                                <div role="tabpanel" class="tab-pane" id="_UsarVariosInsumos">
                                    <div class="col-sm-12 col-lg-12" id="paddinTop10">
                                        <div class="col-md-12 col-sm-12 table-responsive" >
                                            <strong class="text text-success control-label"><h2>Usar herramientas</h2></strong>
                                        </div>
                                        <div class="row col-md-12">
                                            ...
                                            <div class="col-sm-12 col-lg-12 text-center" id="paddinTop10">
                                                <label class="text text-nowrap text-uppercase">Esta seguro de usar estas herramientas?</label>
                                            </div>
                                            <div class="col-sm-12 col-lg-12" id="paddinTop20">
                                                <div class="col-md-12">
                                                    <button id="btnRegresarLista" class="btn btn-default" type="button" href="/#lista" aria-control="" data-toggle="tab" role="tab">Regresar</button>
