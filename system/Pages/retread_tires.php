...
# define wsn from get
$wsn = isset($_GET['wsn']) ? $_GET['wsn'] : null;
...
if ($wsn)
{
    ...
    if (strtolower($USUARIO->getRol()->getNombre())!='asesor') {
        ...
        <script src="lib/controladores/retread_tires.js"></script>
        <div ng-controller="llantas">
            <input type="hidden" id="txtNumberProcess" value="<?= $_GET['wsn'] ?>">
        ...
        <!--                    <td class="mdl-data-table__cell--non-numeric" style="background: {{ objeto.colorUrgente }}">{{ objeto.nombreUrgente }}</td>-->
                            ...
                            <td class="mdl-data-table__cell--non-numeric">
                                <span>
                                    <a ng-click="open_process(objeto)" id="btnProcesoReencauche_{{ objeto.id }}" title="Registrar inspección inicial">
...
# pending add alert that wsn is not present
else header("Location: principal.php?CON=system/pages/inicio.php");
