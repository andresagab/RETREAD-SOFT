...
if (isset($_GET['idReparacion'])) header ("Location: principal.php?CON=system/Pages/cementadoActualizar.php&idReparacion={$_GET['idReparacion']}&accion=preRegistro");
else {
if (isset($_GET['id'])) {
    $objeto=new Cementado('id', $_GET['id'], null, null);
    ...
    $objeto->setIdReparacion($_GET['idReparacion']);
    $reparacion=$objeto->getReparacion();
    $preparacion=$reparacion->getPreparacion();
    $raspado=$preparacion->getRaspado();
    $inspeccionInicial=$raspado->getInspeccion();
...
<div class="col-md-12" ng-controller="usosInsumosPuestoTrabajo">
    <div class="hide" id="cargarDatos" ng-click="cargarProceso(<?= $objeto->getId() ?>, 'getCementadoJSON');cargarEmpleado(<?= $USUARIO->getIdEmpleadoUsuario() ?>);setNumeroProceso(4)"></div>
    <div class="col-md-4" ></div>
    <div class="col-md-4" >
        <strong class="text text-uppercase mdl-color-text--blue control-label"><h2><?=$accion?> cementado</h2></strong>
    </div>
    <div class="col-md-4" >
    ...
    <div class="row col-md-12" id="paddinTop20">
        ...
        <div class="col-md-10" >
            <form class="form-horizontal" name="formulario" method="POST" action="principal.php?CON=system/Pages/cementadoActualizar.php" enctype="multipart/form-data">
                <div class="col-md-2"></div>
                <div class="col-md-8">
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon">* Puesto de trabajo:</span>
                                <select ng-disabled="html.spnListaPuestosTrabajo" class="form-control has-primary input-group-sm" name="idPuestoTrabajo" id="puestoTrabajo" ng-model="html.idPuestoTrabajo" ng-change="cargarPuestoTrabajo(html.idPuestoTrabajo)"><?= Puesto_Trabajo::getDatosEnOptions("proceso=4", null, null)?></select>
                    ...
                    <div class="hidden">
                        ...
                        <div class="col-md-12"><input type="hidden" name="idReparacion" value="<?=$objeto->getIdReparacion()?>"></div>
