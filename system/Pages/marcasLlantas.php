<?php
?>
<script src="lib/controladores/marcasLlanta.js"></script>
<div class="col-md-12" ng-controller="marcasLlantas">
	<div class="col-md-4" ></div>
	<div class="col-md-4" >
            <strong class="mdl-color-text--blue text-uppercase"><h2>Marcas de llanta</h2></strong>
	</div>
	<div class="col-md-4" ></div>
                            ...
                            <tbody>
                                <tr ng-repeat="objeto in objetos | filter: buscar | orderBy: orden">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric">
                                        <h4>
                                            <a href="principal.php?CON=system/Pages/marcasLlantasFormulario.php&id={{ objeto.id }}" title="Modificar">
                            ...
                            <div class='modal-dialog'>
                                <div class='modal-content'>
                                    <div class='modal-header'>
                                        ...
                                        ¿Est&aacute; seguro que desea eliminar la marca de llanta {{ objeto.nombre }}?
                                    </div>
                                    <div class='modal-footer'>
                                        <button type='button' class='btn btn-danger' data-dismiss='modal' >Cancelar</button>
                                        <a href='principal.php?CON=system/Pages/marcasLlantasActualizar.php&id={{ objeto.id }}&accion=Eliminar'><button type='button' class='btn btn-success' >Aceptar</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $("#btnAdicionar").click(function (){
        window.location="principal.php?CON=system/Pages/marcasLlantasFormulario.php";
    });
</script>