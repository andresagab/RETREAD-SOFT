...
if (isset($_GET['idPreparacion'])) header ("Location: principal.php?CON=system/Pages/reparacionActualizar.php&idPreparacion={$_GET['idPreparacion']}&accion=preRegistro");
else {
    if (isset($_GET['id'])) {
        $objeto=new Reparacion('id', $_GET['id'], null, null);
        ...
        $objeto->setIdPreparacion($_GET['idPreparacion']);
        $preparacion=$objeto->getPreparacion();
        $raspado=$preparacion->getRaspado();
        $inspeccionInicial=$raspado->getInspeccion();
        $servicio=$inspeccionInicial->getLlanta()->getServicio();
...
?>
<script src="lib/controladores/usosInsumosReparacion.js"></script>
<div class="col-md-12" ng-controller="usosInsumosReparacion">
    <div class="hide" id="cargarDatos" ng-click="cargarProceso(<?= $objeto->getId() ?>, 'getReparacionJSON');cargarEmpleado(<?= $USUARIO->getIdEmpleadoUsuario() ?>);setNumeroProceso(3)"></div>
    <div class="col-md-4" ></div>
    <div class="col-md-4" >
        <strong class="text text-uppercase mdl-color-text--blue control-label"><h2><?=$accion?> reparacion</h2></strong>
    </div>
    <div class="col-md-4" >
    ...
    <div class="row col-md-12" id="paddinTop20">
        ...
        <div class="col-md-10" >
            <form class="form-horizontal" name="formulario" method="POST" action="principal.php?CON=system/Pages/reparacionActualizar.php" enctype="multipart/form-data">
                <div class="col-md-2"></div>
                <div class="col-md-8">
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon">* Puesto de trabajo:</span>
                                <select ng-disabled="html.spnListaPuestosTrabajo" class="form-control has-primary input-group-sm" name="idPuestoTrabajo" id="puestoTrabajo" ng-model="html.idPuestoTrabajo" ng-change="cargarPuestoTrabajo(html.idPuestoTrabajo)"><?= Puesto_Trabajo::getDatosEnOptions("proceso=3", null, null)?></select>
                    ...
                    <div class="hidden">
                        ...
                        <div class="col-md-12"><input type="hidden" name="idPreparacion" value="<?=$objeto->getIdPreparacion()?>"></div>
                    ...
                    <div class="modal-header">
                        <div role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <!--
                                COMENTADO DESDE 2018-09-08 (AAAA-MM-DD)
                            ...
                            <div class="tab-content">
                                        ...
                                        <center>
                                            <div class="table-responsive">
                                                <table class="mdl-data-table mdl-js-data-table">
                                                    <thead>
                                                        <tr>
                                                            <td class="mdl-data-table__cell--non-numeric hide">
                                ...
                                <!--Registro de insumo-->
                                <!--
                                COMENTADO DESDE EL 2018-09-08 (AAAA-MM-DD)
                                        ...
                                        <div class="row col-md-12">
                                            <div class="col-md-12 page-header" id="paddinTop-20">
                                                ...
                                                <div class="col-sm-12 col-lg-12 text-justify" style="padding-top: 10px">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">* Cantidad usada: </span>
