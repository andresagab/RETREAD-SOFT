        ...
        if (getDiffTimeInSeconds($llanta->getFechaInicioProcesoVal(), date('Y-m-d H:i:s'))>=30) {
                            ...
                            <div class="panel-body">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12" id="paddinTop20" align="center">
                                        <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--red-400 mdl-color-text--white" type="button" ng-click="backPage();">REGRESAR AL LISTADO DE LLANTAS</button>
            ...
            <div class="row col-sm-12 col-md-12 col-lg-12" id="paddinTop20">
                <div class="alert alert-warning">
                    <h3>El formulario de registro se habilitara cuando el cronometro llegue a 30 segundos: {{ inspeccionInicial.data.timeToGo }}/00:30</h3>
