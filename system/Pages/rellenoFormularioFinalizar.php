...
if (isset($_GET['id'])) {
    ...
    $inspeccionInicial=$objeto->getCementado()->getReparacion()->getPreparacion()->getRaspado()->getInspeccion();
...
<div class="col-md-12" ng-controller="rechazoLlanta">
    ...
    <div class="row col-md-12 text-capitalize" id="paddinTop20">
        ...
        <div class="col-md-10">
            <form class="form-horizontal" name="formulario" method="POST" action="principal.php?CON=system/Pages/rellenoActualizar.php">
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group center-block" id="divBtnSeleccionarRechazos" ng-show="!html.estado">
                        <button class="btn btn-success" id="btnSeleccionarRechazos" type="button" href="/#seleccionarRechazos" data-toggle="modal" ng-click="loadRechazosOfProceso(<?=$llanta->getId()?>, 5)">Seleccionar rechazos</button>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                    ...
                    <div class="hidden">
                        ...
                        <div class="col-md-12"><input type="hidden" name="idPreparacion" value="<?=$_GET['idPreparacion']?>"></div>
                    </div>
                    <div class="form-group" id="paddinTop20">
                        ...
                        <input class="btn btn-warning" type="submit" name="accion" value="<?=$accion?>">
                    </div>
                </div>
                <div class="col-md-2"></div>
            </form>
                ...
                <div class='modal-footer'>
                    ...
                    <a href="/#solicitudEnviada" data-toggle="modal">
                        <button ng-hide="!chequeados" type='button' class='btn btn-success {{ objeto.btnAprobar }}' id="btnAprobar" data-dismiss="modal"
                                ng-click="registrarRechazos(<?= $objeto->getId() ?>, observaciones, 5, <?=$llanta->getId()?>)"
                                >Registrar</button>
                    </a>
                </div>
            </div>
