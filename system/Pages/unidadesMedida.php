<?php
?>
<script src="lib/controladores/unidadesMedida.js"></script>
<div class="col-md-12" ng-controller="unidadesMedida">
        <div class="col-lg-12 hidden" id="cargarLista" ng-click="cargarLista()"></div>
	<div class="col-md-4" ></div>
	<div class="col-md-4" >
            <strong class="mdl-color-text--blue text-uppercase"><h2>Unidades de medida</h2></strong>
	</div>
	<div class="col-md-4" ></div>
        ...
        <div class="row col-md-12">
            ...
            <div class="col-md-4">
                <div class="col-md-12 form-group-sm">
                    <input class="col-md-12 form-control" id="buscar" name="buscar" placeholder="Buscar por: Nombre, sigla o descripcion" ng-model="buscar">
                </div>
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-2">
                        ...
                        <table class="mdl-data-table mdl-js-data-table">
                            <thead class="text text-uppercase">
                                <tr class="active">
                                    ...
                                    <th class="mdl-data-table__cell--non-numeric" ng-click="orden='sigla'">Sigla</th>
                            ...
                            <tbody>
                                <tr ng-repeat="objeto in objetos | filter: buscar | orderBy: orden">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric">{{ objeto.sigla }}</td>
                                    <td class="mdl-data-table__cell--non-numeric">{{ objeto.descripcion }}</td>
                                    <td class="mdl-data-table__cell--non-numeric">
                                        <h4><a href="principal.php?CON=system/Pages/unidadesMedidaFormulario.php&id={{ objeto.id }}" title="Modificar">
                            ...
                            <div class='modal-dialog'>
                                <div class='modal-content'>
                                    <div class='modal-header'>
                                        ...
                                        ¿Est&aacute; seguro que desea eliminar la unidad de medida {{ objeto.nombre }} ({{ objeto.sigla }})?
                                    </div>
                                    <div class='modal-footer'>
                                        <button type='button' class='btn btn-danger' data-dismiss='modal' >Cancelar</button>
                                        <a href='principal.php?CON=system/Pages/unidadesMedidaActualizar.php&id={{ objeto.id }}&accion=Eliminar'><button type='button' class='btn btn-success' >Aceptar</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $("#btnAdicionar").click(function (){
        window.location="principal.php?CON=system/Pages/unidadesMedidaFormulario.php";
    });
</script>