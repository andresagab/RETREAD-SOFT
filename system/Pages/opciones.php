<?php
?>
<script src="lib/controladores/opciones.js"></script>
<div class="col-md-12" ng-controller="opciones">
	<div class="col-md-12" id="paddinTop30"></div>
	<div class="col-md-4" ></div>
	<div class="col-md-4" >
            <strong class="text text-success control-label"><h2>Opciones del sistema</h2></strong>
	</div>
	<div class="col-md-4" ></div>
            ...
            <div class="col-md-10">
                <div class="table-responsive">
                    <table class="table table-hover table-striped">
                        <tr class="active">
                            <th ng-click="orden='nombre'">Nombre</th><th ng-click="orden='descripcion'">Descripcion</th><th ng-click="orden='ruta'">Ruta</th><th>Acciones</th>
                        </tr>
                        <tr ng-repeat="objeto in objetos | filter: buscar | orderBy: orden">
                            ...
                            <td>
                                <h4>
                                    <a href="principal.php?CON=system/Pages/opcionesFormulario.php&id={{ objeto.id }}"><span class="glyphicon glyphicon-refresh"></span></a>
                                    <a href='/#eliminar{{ objeto.id }}' title='Eliminar' data-toggle='modal'><span class="glyphicon glyphicon-remove-circle"></span></a>
                                </h4>
                            </td>
                        </tr>
                    </table>
                        ...
                        <div class='modal-dialog'>
                            <div class='modal-content'>
                                ...
                                <div class='modal-footer'>
                                    ...
                                    <a href='principal.php?CON=system/Pages/opcionesActualizar.php&id={{ objeto.id }}&accion=Eliminar'><button type='button' class='btn btn-success' >Aceptar</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $("#btnAdicionar").click(function (){
        window.location="principal.php?CON=system/Pages/opcionesFormulario.php";
    });
</script>