        ...
        <form class="form-horizontal" name="formulario" method="POST" action="principal.php?CON=system/Pages/inspeccionFinalActualizar.php" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group center-block" id="divBtnSeleccionarRechazos" ng-show="!html.estado">
                    <button class="btn btn-success" id="btnSeleccionarRechazos" type="button" href="/#seleccionarRechazos" data-toggle="modal" ng-click="loadRechazosOfProceso(<?=$llanta->getId()?>, 9)">Seleccionar rechazos</button>
                </div>
                <div class="form-group">
                    <div class="input-group">
                ...
                <div class="form-group" id="paddinTop20">
                    <a href="principal.php?CON=system/Pages/procesoServicio.php&id=<?=$objeto->getVulcanizado()->getEmbandado()->getCorteBanda()->getRelleno()->getCementado()->getReparacion()->getPreparacion()->getRaspado()->getInspeccion()->getIdLlanta()?>"><input class="btn btn-danger" type="button" name="Cancelar" value="Cancelar"></a>
                ...
                <div class='modal-footer'>
                    ...
                    <a href="/#solicitudEnviada" data-toggle="modal">
                        <button ng-hide="!chequeados" type='button' class='btn btn-success {{ objeto.btnAprobar }}' id="btnAprobar" data-dismiss="modal"
                                ng-click="registrarRechazos(<?= $objeto->getNextId() ?>, observaciones, 9, <?=$llanta->getId()?>)"
                                >Registrar</button>
                    </a>
                </div>
            </div>
