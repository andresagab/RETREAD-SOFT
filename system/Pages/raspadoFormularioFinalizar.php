...
<div class="col-md-12" ng-controller="rechazoLlanta">
    ...
    <div class="row col-md-12 text-capitalize" id="paddinTop20">
        ...
        <div class="col-md-10">
            <form class="form-horizontal" name="formulario" method="POST" action="principal.php?CON=system/Pages/raspadoActualizar.php">
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group center-block" id="divBtnSeleccionarRechazos" ng-show="!html.estado">
                        <button class="btn btn-success" id="btnSeleccionarRechazos" type="button" href="/#seleccionarRechazos" data-toggle="modal" ng-click="loadRechazosOfProceso(<?=$llanta->getId()?>, 1)">Seleccionar rechazos</button>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                    ...
                    <div class="form-group" id="paddinTop20">
                        <a href="principal.php?CON=system/Pages/procesoServicio.php&id=<?=$inspeccionInicial->getIdLlanta()?>"><input class="btn btn-danger" type="button" name="Cancelar" value="Cancelar"></a>
                ...
                <div class='modal-footer'>
                    ...
                    <a href="/#solicitudEnviada" data-toggle="modal">
                        <button ng-hide="!chequeados" type='button' class='btn btn-success {{ objeto.btnAprobar }}' id="btnAprobar" data-dismiss="modal"
                                ng-click="registrarRechazos(<?= $objeto->getId() ?>, observaciones, 1, <?=$llanta->getId()?>)"
...
//        $("#verDetalles").click();
//        if(document.getElementById("estado").checked) document.getElementById("textoEstado").innerHTML='Aprobado';
//        else document.getElementById("textoEstado").innerHTML='Reprobado';
//    });
//    
