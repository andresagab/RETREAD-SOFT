...
if (isset($_GET['id'])) {
    ...
    $accion="Modificar";
    if (strpos($objeto->getNombre(), "class=")>0) $objeto->setNombre(null);
} else {
...
<div class="col-md-12">
	...
	<div class="col-md-6" >
            <strong class="text text-success control-label"><h2><?=$accion?> menu</h2></strong>
	</div>
	<div class="col-md-3" ></div>
	<div class="row col-md-12 text-capitalize" id="paddinTop20">
        <div class="col-md-1"></div>
        <div class="col-md-10">
            <form class="form-horizontal" name="formulario" method="POST" action="principal.php?CON=system/Pages/menuActualizar.php">
                <div class="form-group">
                    <label class="control-label col-md-5">Nombre:</label>
                    <div class="col-md-5">
                        <input type="text" class="form-control has-primary" name="nombre" value="<?= rtrim($objeto->getNombre())?>" placeholder="Ejemplo: Configuracion" maxlength="50" required=""/>
                    </div>
                </div>
