...
if (isset($_GET['idEmbandado'])) header ("Location: principal.php?CON=system/Pages/vulcanizadoActualizar.php&idEmbandado={$_GET['idEmbandado']}&accion=preRegistro");
else {
    if (isset($_GET['id'])) {
        $objeto=new Vulcanizado('id', $_GET['id'], null, null);
        $embandado=$objeto->getEmbandado();
        ...
        $objeto->setIdEmbandado($_GET['idEmbandado']);
        $embandado=$objeto->getEmbandado();
        $corteBanda=$embandado->getCorteBanda();
        $relleno=$corteBanda->getRelleno();
        $cementado=$relleno->getCementado();
...
<div class="col-md-12" ng-controller="usosInsumosPuestoTrabajo">
    <div class="hide" id="cargarDatos" ng-click="cargarProceso(<?= $objeto->getId() ?>, 'getVulcanizadoJSON');cargarEmpleado(<?= $USUARIO->getIdEmpleadoUsuario() ?>);setNumeroProceso(8)"></div>
    <div class="col-md-4" ></div>
    <div class="col-md-4" >
        <strong class="text text-uppercase mdl-color-text--blue control-label"><h2><?=$accion?> vulcanizado</h2></strong>
    </div>
    <div class="col-md-4" >
    ...
    <div class="row col-md-12" id="paddinTop20">
        ...
        <div class="col-md-10" >
            <form class="form-horizontal" name="formulario" method="POST" action="principal.php?CON=system/Pages/vulcanizadoActualizar.php" enctype="multipart/form-data">
                <div class="col-md-2"></div>
                <div class="col-md-8">
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon">* Puesto de trabajo:</span>
                                <select ng-disabled="html.spnListaPuestosTrabajo" class="form-control has-primary input-group-sm" name="idPuestoTrabajo" id="puestoTrabajo" ng-model="html.idPuestoTrabajo" ng-change="cargarPuestoTrabajo(html.idPuestoTrabajo)"><?= Puesto_Trabajo::getDatosEnOptions("proceso=8", null, null)?></select>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <span class="input-group-addon">
                                <label class="pull-left mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-1">
                                    <input type="radio" id="option-1" class="mdl-radio__button" name="metodo" value="0" checked>
                                    <span class="mdl-radio__label">Innerlop</span>
                                </label>
                                <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-2">
                                    <input type="radio" id="option-2" class="mdl-radio__button" name="metodo" value="1">
                                    <span class="mdl-radio__label">Rin</span>
                                </label>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="hidden">
                        ...
                        <div class="col-md-12"><input type="hidden" name="idEmbandado" value="<?=$objeto->getIdEmbandado()?>"></div>
