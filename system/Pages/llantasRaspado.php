...
if (strtolower($USUARIO->getRol()->getNombre())!='asesor') {
    ...
    <script src="lib/controladores/llantasRaspado.js"></script>
    <div ng-controller="llantasRaspado">
        <input type="hidden" id="txtNumberProcess" value="1">
                        ...
                        <div class="col-sm-12 col-lg-12">
                            <div class="col-sm-12 col-lg-12">
                                <span class="mdl-chip mdl-chip--contact">
                                    ...
                                    <span class="mdl-chip__text">La llanta no registra proceso de raspado</span>
                                </span>
                            </div>
                            <div class="col-sm-12 col-lg-12">
                                <span class="mdl-chip mdl-chip--contact">
                                    <span class="mdl-chip__contact mdl-color--orange-400 mdl-color-text--white">2</span>
                                    <span class="mdl-chip__text">La llanta ya inicio proceso de raspado, pero esta a la espera de la habilitación del formulario de registro</span>
                                </span>
                            </div>
                            <div class="col-sm-12 col-lg-12">
                                <span class="mdl-chip mdl-chip--contact">
                                    <span class="mdl-chip__contact mdl-color--yellow-400 mdl-color-text--black">3</span>
                                    <span class="mdl-chip__text">El formulario de registro correspondiente al proceso de raspado ya esta disponible.</span>
                                </span>
                            </div>
                            <div class="col-sm-12 col-lg-12">
                                <span class="mdl-chip mdl-chip--contact">
                                    <span class="mdl-chip__contact mdl-color--green-500 mdl-color-text--white">4</span>
                                    <span class="mdl-chip__text">El proceso de raspado fue registrado con exito</span>
                                </span>
                            </div>
                        </div>
                    </div>
