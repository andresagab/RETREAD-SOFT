<?php
?>
<script src="lib/controladores/gravadosLlanta.js"></script>
<div class="col-md-12" ng-controller="gravadosLlanta">
        <div class="col-lg-12 hidden" id="cargarLista" ng-click="cargarLista()"></div>
	<div class="col-md-3" ></div>
	<div class="col-md-6" >
        <strong class="mdl-color-text--blue text-uppercase"><h2>Gravados</h2></strong>
	</div>
	<div class="col-md-3" ></div>
                            ...
                            <tbody>
                                <tr ng-repeat="objeto in objetos | filter: buscar | orderBy: orden">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric">
                                        <h4>
                                            <a href="principal.php?CON=system/Pages/gravadosLlantaFormulario.php&id={{ objeto.id }}" title="Modificar">
                                            ...
                                            <!--<a id="paddingLeft10" href="principal.php?CON=system/Pages/referenciasGravado.php&id={{ objeto.id }}" title="Gestionar referencias del gravado"><span class="fa fa-registered"></span></a>-->
                                        </h4>
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <div class='modal-dialog'>
                                <div class='modal-content'>
                                    <div class='modal-header'>
                                        ...
                                        ¿Est&aacute; seguro que desea eliminar el gravado {{ objeto.nombre }}?
                                    </div>
                                    <div class='modal-footer'>
                                        <button type='button' class='btn btn-danger' data-dismiss='modal' >Cancelar</button>
                                        <a href='principal.php?CON=system/Pages/gravadosLlantaActualizar.php&id={{ objeto.id }}&accion=Eliminar'><button type='button' class='btn btn-success' >Aceptar</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $("#btnAdicionar").click(function (){
        window.location="principal.php?CON=system/Pages/gravadosLlantaFormulario.php";
    });
</script>