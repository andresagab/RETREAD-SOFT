<?php
?>
<script src="lib/controladores/marcasVehiculo.js"></script>
<div class="col-md-12" ng-controller="marcasVehiculo">
        <div class="col-lg-12 hidden" id="cargarLista" ng-click="cargarLista()"></div>
	<div class="col-md-3" ></div>
	<div class="col-md-6" >
            <strong class="mdl-color-text--blue text-uppercase"><h2>Marcas de vehiculo</h2></strong>
	</div>
	<div class="col-md-3" ></div>
                            ...
                            <tbody>
                                <tr ng-repeat="objeto in objetos | filter: buscar | orderBy: orden">
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric">
                                        <h4>
                                            <a href="principal.php?CON=system/Pages/marcasVehiculoFormulario.php&id={{ objeto.id }}" title="Modificar">
                            ...
                            <div class='modal-dialog'>
                                <div class='modal-content'>
                                    <div class='modal-header'>
                                        ...
                                        ¿Est&aacute; seguro que desea eliminar la marca de vehiculo {{ objeto.nombre }}?
                                    </div>
                                    <div class='modal-footer'>
                                        <button type='button' class='btn btn-danger' data-dismiss='modal' >Cancelar</button>
                                        <a href='principal.php?CON=system/Pages/marcasVehiculoActualizar.php&id={{ objeto.id }}&accion=Eliminar'><button type='button' class='btn btn-success' >Aceptar</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $("#btnAdicionar").click(function (){
        window.location="principal.php?CON=system/Pages/marcasVehiculoFormulario.php";
    });
</script>