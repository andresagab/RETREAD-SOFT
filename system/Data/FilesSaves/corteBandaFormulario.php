...
if (isset($_GET['idRelleno'])) header ("Location: principal.php?CON=system/Pages/corteBandaActualizar.php&idRelleno={$_GET['idRelleno']}&accion=preRegistro");
else {
    if (isset($_GET['id'])) {
        $objeto=new Corte_Banda('id', $_GET['id'], null, null);
        ...
        $objeto->setIdRelleno($_GET['idRelleno']);
        $relleno=$objeto->getRelleno();
        $cementado=$relleno->getCementado();
        $reparacion=$cementado->getReparacion();
        $preparacion=$reparacion->getPreparacion();
...
<div class="col-md-12" ng-controller="usosInsumosPuestoTrabajo">
    <div class="hide" id="cargarDatos" ng-click="cargarProceso(<?= $objeto->getId() ?>, 'getCorteBandaJSON');cargarEmpleado(<?= $USUARIO->getIdEmpleadoUsuario() ?>);setNumeroProceso(6)"></div>
    <div class="col-md-4" ></div>
    <div class="col-md-4" >
        <strong class="text text-primary control-label"><h2><?=$accion?> corte de banda</h2></strong>
    </div>
    <div class="col-md-4" >
    ...
    <div class="row col-md-12" id="paddinTop20">
        ...
        <div class="col-md-10" >
            <form class="form-horizontal" name="formulario" method="POST" action="principal.php?CON=system/Pages/corteBandaActualizar.php" enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                    ...
                    <div class="hidden">
                        ...
                        <div class="col-md-12"><input type="hidden" name="idRelleno" value="<?=$objeto->getIdRelleno()?>"></div>
                    ...
                    <div class="form-group" id="paddinTop30">
                         <div class="col-md-2"></div>
                         <div class="col-md-2"><a href="principal.php?CON=system/Pages/procesoServicio.php&id=<?=$llanta->getId()?>"><input class="btn btn-danger" type="button" name="Cancelar" value="Cancelar"></a></div>
                         <div class="col-md-2"></div>
                         <div class="col-md-2"><input ng-disabled="html.btnRegistrarProceso" class="btn btn-info" type="submit" name="accion" value="<?=$accion?>"></div>
                    </div>
                </div>
                <div class="col-md-2"></div>
            </form>
                                                ...
                                                <table class="mdl-data-table mdl-js-data-table">
                                                    ...
                                                    <tbody>
                                                        <tr ng-repeat="dato in insumos | orderBy: orden">
                                                            <td class="mdl-data-table__cell--non-numeric">
                                                                <input ng-hide="dato.btnUsar" class="form-control-sm" type="checkbox" id="_chkInsumo" ng-checked="dato.chk" ng-model="dato.chk" ng-change="separarIdInsumo(dato.chk, dato.id)">
                                                            </td>
                                                            <td>
                                                                <div class="thumbnail">
                                                            ...
                                                            <td>
                                                                <h4>
                                                                    <a ng-show="!dato.btnUsar" href="/#usarInsumo_{{ dato.id }}" aria-control="" data-toggle="tab" rol="tab"><span class="text-success fa fa-handshake-o" title="Registrar uso"></span></a>
                                                                    <a ng-show="!dato.btnUsar" id="paddingLeft10" ng-click="seleccionarInsumoUsarYTerminar(dato)" href='/#UsarYTerminarInsumo' title='Registrar uso y terminacion' aria-control="" data-toggle="tab" role="tab" ><span class="text-warning fa fa-legal"></span></a>
