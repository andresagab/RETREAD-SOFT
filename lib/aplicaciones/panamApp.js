...
panamApp.constant('configuracionGlobal', {
    ...
    'scripts': document.location.origin + '/Work/PANAM/system/Scripts',//Configuracion de la carpeta de datos
    'templatesPrint': document.location.origin + '/Work/PANAM/system/Print',
    'templates': document.location.origin + '/Work/PANAM/system/Templates',
    'export': document.location.origin + '/Work/PANAM/system/Export',
