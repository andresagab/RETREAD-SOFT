panamApp.controller('raspado', function ($scope, $interval) {
    ...
    $scope.resetProcces = function (id){
        window.location = 'principal.php?CON=system/pages/raspadoActualizar.php&id=' + id + '&idLlanta=' + document.getElementById('txtIdLlanta').value + '&idPastProcess=' + document.getElementById('txtPastProcess').value + '&accion=resetProcess';//review
    };
