panamApp.controller('soat', function ($scope, configuracionGlobal, $http, $location){
    $scope.cargarDatos=function(_idVehivulo){
    	$http.get(configuracionGlobal.scripts + "/listadosJSON.php?metodo=soatsJSON&idVehiculo="+_idVehivulo).then(function (respuesta){
