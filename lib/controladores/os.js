panamApp.controller('os', function ($scope, configuracionGlobal, $http, $localStorage, $timeout){
    ...
    $scope.imprimirHoja=function (){
        ...
        //window.open(configuracionGlobal.templatesPrint + "/ordenServicioImprimir.php?id=" + $scope.ordenServicio.id, null, 'toolbar=no, directories=no, width=500, height=350, resizable=no,left=280, top=240');
    }
